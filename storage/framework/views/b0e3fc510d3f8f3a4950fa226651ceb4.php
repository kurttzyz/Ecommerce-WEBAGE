...
<head>
	...
	<title><?php echo $__env->yieldContent('title_seller'); ?></title>
		...
		<nav id="sidebar" class="sidebar js-sidebar">
			<div class="sidebar-content js-simplebar">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item <?php echo e(request()->routeIs('seller.dashboard') ? 'active' : ''); ?>">
						<a class="sidebar-link" href="<?php echo e(route('seller.dashboard')); ?>">
					...
					<li class="sidebar-item <?php echo e(request()->routeIs('seller.store.create') ? 'active' : ''); ?>">
						<a class="sidebar-link" href="<?php echo e(route('seller.store.create')); ?>">
							<i class="align-middle" data-feather="plus"></i> <span class="align-middle">Create Mentors</span>
						</a>
					</li>

					<li class="sidebar-item <?php echo e(request()->routeIs('seller.store.manage') ? 'active' : ''); ?>">
						<a class="sidebar-link" href="<?php echo e(route('seller.store.manage')); ?>">
					...
					<li class="sidebar-item <?php echo e(request()->routeIs('courses.create') ? 'active' : ''); ?>">
						<a class="sidebar-link" href="<?php echo e(route('courses.create')); ?>">
					...
					<li class="sidebar-item <?php echo e(request()->routeIs('courses.index') ? 'active' : ''); ?>">
					...
					<li class="sidebar-item <?php echo e(request()->routeIs('submissions') ? 'active' : ''); ?>" style="position: relative;">
						<a class="sidebar-link" href="<?php echo e(route('submissions')); ?>">
					...
					<li class="sidebar-item <?php echo e(request()->routeIs('courses.show.archive') ? 'active' : ''); ?>">
						<a class="sidebar-link" href="<?php echo e(route('courses.show.archive')); ?>">
					...
					<li class="sidebar-item <?php echo e(request()->routeIs('seller.product') ? 'active' : ''); ?>">
						<a class="sidebar-link" href="<?php echo e(route('seller.product')); ?>">
							<i class="align-middle" data-feather="plus"></i> <span class="align-middle">Create Courses</span>
						</a> 
					</li>

					<li class="sidebar-item <?php echo e(request()->routeIs('seller.product.manage') ? 'active' : ''); ?>">
						<a class="sidebar-link" href="<?php echo e(route('seller.product.manage')); ?>">
					...
					<li class="sidebar-item <?php echo e(request()->routeIs('certificates.create') ? 'active' : ''); ?>">
						<a class="sidebar-link" href="<?php echo e(route('certificates.create')); ?>">
							<i class="align-middle" data-feather="plus"></i> <span class="align-middle">Issue Certificates</span>
						</a>
					</li>

					<li class="sidebar-item <?php echo e(request()->routeIs('certificates.index') ? 'active' : ''); ?>">
						<a class="sidebar-link" href="<?php echo e(route('certificates.index')); ?>">
							<i class="align-middle" data-feather="award"></i> <span class="align-middle">Manage Certificates</span>
						</a>
					</li>

					<li class="sidebar-item <?php echo e(request()->routeIs('achievements.create') ? 'active' : ''); ?>">
						<a class="sidebar-link" href="<?php echo e(route('achievements.create')); ?>">
							<i class="align-middle" data-feather="plus"></i> <span class="align-middle">Create Achievements</span>
						</a>
					</li>

					<li class="sidebar-item <?php echo e(request()->routeIs('mentor.assign.index') ? 'active' : ''); ?>">
						<a class="sidebar-link" href="<?php echo e(route('mentor.assign.index')); ?>">
...
[$__name, $__params] = $__split('seller-search-product');

$__html = app('livewire')->mount($__name, $__params, 'lw-390155372-0', $__slots ?? [], get_defined_vars());
...
?>
						...
						<div class="flex items-center space-x-8 text-lg">
							...
							<a id="shop-link" href="<?php echo e(route('seller.store.view')); ?>" 
...
[$__name, $__params] = $__split('seller-filter-product');

$__html = app('livewire')->mount($__name, $__params, 'lw-390155372-1', $__slots ?? [], get_defined_vars());
...
?>
			...
			<main class="content py-4">
				<div id="content-container">
					<?php echo $__env->yieldContent('seller_layout'); ?>
					<?php echo $__env->yieldContent('seller_home'); ?>
					<?php echo $__env->yieldContent('seller_shop'); ?>
					<?php echo $__env->yieldContent('seller_cart'); ?>
				</div>
			</main>
...
<script>
	$('#shop-link').on('click', function(event) {
		...
		const url = '<?php echo e(route('seller.store.view')); ?>';
		$.ajax({
			url: url,
			method: 'GET',
	...
	$('#cart-link').on('click', function(event) {
		...
		event.preventDefault();
		const url = '<?php echo e(route('seller.cart.index')); ?>';
		$.ajax({
			url: url,
			method: 'GET',
			success: function(response) {
	...
	$('#homepage-link').on('click', function(event) {
		...
		event.preventDefault();
		const url = '<?php echo e(route('seller.dashboard')); ?>';
		$.ajax({
			url: url,
			method: 'GET',
			success: function(response) {
...
<script>
	document.getElementById('profileForm').addEventListener('submit', async function (e) {
		...
		const response = await fetch("<?php echo e(route('profile.seller.upload')); ?>", {
			method: 'POST',
			headers: {
...
<?php /**PATH C:\music\resources\views/seller/layouts/layout.blade.php ENDPATH**/ ?>