...
<?php $__env->startSection('admin_layout'); ?>
            ...
            canvas {
                ...
                height: auto !important;
                        ...
                        <div id="report-container" class="px-6 py-4">
                            ...
                            <!-- Filter Form -->
                            <form method="GET" action="<?php echo e(route('admin')); ?>" class="mb-6 flex flex-col gap-4 items-end">
                                <div>
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', function () {
                                // User stats
                                const userStatsData = <?php echo json_encode([
        'users' => $totalUsers ?? 0,
        ...
        'customers' => $totalCustomers ?? 0
                                ...
                                // Doughnut Chart
                                const studentContinuityData = <?php echo json_encode([
...
<?php echo $__env->make('admin.layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\music\resources\views/admin/admin.blade.php ENDPATH**/ ?>