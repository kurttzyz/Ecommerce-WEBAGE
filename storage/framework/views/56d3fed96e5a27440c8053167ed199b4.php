...
<body>
  ...
  <form action="<?php echo e(route('seller.submitform')); ?>" method="POST" enctype="multipart/form-data" novalidate>
    <?php echo csrf_field(); ?>
    ...
    <div class="grid">
      ...
      <div class="checkbox-group">
        <label>
          ...
          I agree to the <a href="<?php echo e(route('policies')); ?>"  rel="noopener noreferrer">terms and conditions</a>
        </label>        
        <label>
...
</html><?php /**PATH C:\music\resources\views/seller/become_seller/form.blade.php ENDPATH**/ ?>