...
<center>
    <h1 class="text-white text-2xl font-bold animate-fade-in-up">Explore Our All Courses In <?php echo e($category->category_name); ?> Category</h1>
</center>
    ...
    <?php $__empty_1 = true; $__currentLoopData = $product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="bg-black shadow rounded overflow-hidden transform hover:scale-105 transition duration-300 ease-in-out animate-fade-in-up">
            ...
            <div class="p-2 text-center">
                ...
                <a href="<?php echo e(route('category.view', ['product_name' => $pro->product_name])); ?>"
...
<?php echo $__env->make('customer.layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\music\resources\views/customer/category/showproduct.blade.php ENDPATH**/ ?>