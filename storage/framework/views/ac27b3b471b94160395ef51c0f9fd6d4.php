...
<div class="search-bar-wrap hidden md:block">
    <form action="<?php echo e(route('seller.search.product')); ?>" method="GET" class="w-full max-w-lg mx-auto">
...
<?php /**PATH C:\music\resources\views/livewire/seller-search-product.blade.php ENDPATH**/ ?>