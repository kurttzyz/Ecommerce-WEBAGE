...
<?php $__env->startSection('seller_layout'); ?>
    ...
    <div class="relative bg-black border border-gray-200 shadow-2xs rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70 animate-fade-in">
        ...
        <div class="mt-6">
            ...
            <form action="<?php echo e(route('seller.product.review.store', $product->id)); ?>" method="POST" class="mt-2 space-y-2">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('seller.layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\music\resources\views/seller/category/viewproduct.blade.php ENDPATH**/ ?>