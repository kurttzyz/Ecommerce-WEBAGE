<div class="search-bar-wrap hidden md:block">
    <form action="<?php echo e(route('customer.search.products')); ?>" method="GET" class="w-full max-w-lg mx-auto">
...
<?php /**PATH C:\music\resources\views/livewire/product-search-component.blade.php ENDPATH**/ ?>