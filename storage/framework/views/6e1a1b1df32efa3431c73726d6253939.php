            ...
            <div
                ...
                <div class="p-6 md:flex md:items-start md:justify-between">
                    ...
                    <div class="mt-6 md:mt-0 md:w-1/4 text-right">
                        <a href="<?php echo e(route('customer.store.show', $store->slug)); ?>"
...
<?php echo $__env->make('customer.layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\music\resources\views/customer/store/viewstore.blade.php ENDPATH**/ ?>