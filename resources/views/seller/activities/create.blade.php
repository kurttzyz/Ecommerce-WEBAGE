...
@section('seller_layout')
    ...
    <div>
        ...
        <center>
                ...
                <h1 class="text-xl font-bold text-black text-center">Add Activity to Session: {{ $course->title }}</h1>
                <hr class="my-4 border-black animate-fade-in-up">
                <br>
                <form action="{{ route('activities.store', $course->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mt-6 bg-gray-100 p-4 rounded">
                        ...
                        <a href="{{ asset('storage/guides/activity-creation-guide.pdf') }}" target="_blank"
