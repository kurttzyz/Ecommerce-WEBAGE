...
<div class="text-black bg-black container mx-auto p-6 fade-in">
    ...
    <div class="mt-6 p-4 bg-white text-black rounded-xl shadow border dark:border-neutral-700">
        ...
        <div class="mt-4">
            ...
            <center>
                <form action="{{ route('seller.orders.createshippingpayment', $order) }}" method="POST">
                    @csrf
            ...
            <center>
                <a href="{{ route('seller.orders.showorder', $order) }}" class="bg-green-500 text-white px-6 py-3 rounded-md hover:bg-black focus:outline-none focus:ring-2 focus:ring-yellow-300">
                    Shipping Details
                </a>
            </center>
            @endif
