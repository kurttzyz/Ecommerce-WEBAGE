...
@section('title_customer', 'ConnectingNotes')
            ...
            @forelse ($achievements as $achievement)
                <div
                    ...
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <h2 class="text-xl font-bold text-yellow-700">{{ $achievement->title }}</h2>
                    </div>

                    <p class="text-sm text-gray-700 mb-2">{{ $achievement->description }}</p>

                    <p class="text-xs text-gray-600 italic mb-2">
                        Issued by:
                        <span class="font-semibold text-gray-800">{{ $achievement->issued_by ?? 'Unknown' }}</span>
                    </p>
                    @php
                    ...
                    <div class="mt-4">
                        ...
                        <div class="w-full bg-gray-200 rounded-full h-4 overflow-hidden shadow-inner">
                            <div class="{{ $progressColor }} h-4 rounded-full transition-all duration-500 ease-out animate-pulse"
