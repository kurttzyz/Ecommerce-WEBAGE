...
<div class="bg-black max-w-7xl mx-auto">
    ...
    <div class="text-center bg-black text-white py-12 mt-16 rounded-xl shadow-xl animate-fade-in-up">
        <h2 class="text-3xl font-bold text-white">Welcome to WebAge!</h2>
