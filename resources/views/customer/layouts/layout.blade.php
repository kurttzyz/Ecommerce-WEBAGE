		...
		<nav id="sidebar" class="sidebar js-sidebar">
			<div class="sidebar-content js-simplebar">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item {{request()->routeIs('customer.orders.order')?'active':''}}">
						<a class="sidebar-link" href="{{route('customer.orders.order')}}">
					...
					<li class="sidebar-item {{request()->routeIs('orders.pending')?'active':''}}">
			...
			<nav class="navbar navbar-expand navbar-light navbar-bg">
				...
				<div class="container">
					...
					<div class="container mx-auto px-6 flex justify-between items-center">
						<!-- Logo -->
						<a href="{{route('customer.dashboard')}}" class="text-2xl font-bold text-black hover:text-red-300 transition duration-300">WebAge</a>
					
						<!-- Product Search Component (Responsive) -->
						<div class="text-black hidden md:flex items-center space-y-6">
							@livewire('product-search-component')
						</div>
					
						<!-- Navbar Links -->
						<div class="flex items-center space-x-8 text-lg">
							<a href="{{route('customer.dashboard')}}" class="text-black flex items-center hover:text-red-500 no-underline">
								<i class="align-middle me-2 hover:text-red-500" data-feather="home"></i> Home
							</a>
							
							<a href="{{ route('customer.store.view') }}" 
