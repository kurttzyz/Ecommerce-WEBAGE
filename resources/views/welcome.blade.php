...
<head>
    ...
    <!-- CSS Files -->
    <link rel="stylesheet" href="{{ asset('landingpage/css/base-style.css') }}">
            ...
            <div class="container-fluid">
                ...
                <div class="ch-header rounded-10 py-2 py-xl-0 bg-white px-3">
                    <a href="#" class="h-logo pe-3" style="display: flex; align-items: center;">
                        <img src="{{ asset('landingpage/img/notes3.png') }}" style="width:100px; margin-right: 5px;" alt="Logo">
                    ...
                    <div class="header-right">
                            ...
                            <ul class="h-menu">
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="{{ route('login') }}">Schedule/Book Session</a></li>
                        ...
                        <div class="h-btn d-none d-xl-block ms-xl-4">
                            <a href="{{ route('login') }}" class="btn btn-primary rounded-40">
                                Sign In
                            </a>
                            <a href="{{ route('register') }}" class="text-heading fw-semibold ms-3">
                                Sign Up
                            </a>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-5 d-none d-md-block">
                        <div class="hero-banner-img pe-md-5">
                            <img src="{{ asset('landingpage/img/notes2.png') }}" alt="note" class="opacity-20">
                        </div>
    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6" data-aos="zoom-in">
                <img src="{{ asset('landingpage/img/note4.jpg') }}" alt="ConnectingNotes interface"
...
<div class="token-info-sec">
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6" data-aos="zoom-in">
                <img src="{{ asset('landingpage/img/logo.png') }}" alt="ConnectingNotes interface"
                    style="width: 100%; opacity: 0.9; border-radius: 12px; box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);">
            </div>
        </div>
    </div>
                    ...
                    <div class="col-lg-3 col-md-6 py-4">
                        <div class="footer-widget">
                            <a href="/" class="footer-logo mb-4">
                                <img src="{{ asset('landingpage/img/logo.png') }}" style="width:auto" alt="">
                            </a>
                    ...
                    <div class="col-lg-3 col-sm-6 py-4">
                        <div class="footer-widget">
                            ...
                            <ul class="footer-widget-menu column-2">
                                <li><a href="{{route('login')}}">Courses/Lessons</a></li>
                                <li><a href="{{route('login')}}">Mentors</a></li>
                                <li><a href="{{route('login')}}">Schedule/Book Session</a></li>
                                <li><a href="{{route('login')}}">Resources</a></li>
                    ...
                    <div class="col-lg-2 col-sm-6 py-4">
                        <div class="footer-widget">
                            ...
                            <ul class="footer-widget-menu mb-4">
                                <li><a href="{{route('contract')}}">Contract and Agreement</a></li>
                                <li><a href="{{route('policy')}}">Privacy Policy</a></li>
                                <li><a href="{{'login'}}">Become A Mentor</a></li>
                            </ul>
                        </div>
                    </div>
